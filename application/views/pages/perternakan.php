    ...
    <?php foreach ($animal_farms->result_array() as $animal_farms_item): ?>
      <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
        <div class="living_box"><a href="#">
            <?php if (is_file($animal_farms_item['pr_photo'])): ?>
              <img src="<?php echo base_url() . $animal_farms_item['pr_photo']; ?> " class="img-responsive" alt="<?php echo $animal_farms_item['pr_title'] ?>"/>
            <?php else : ?>
