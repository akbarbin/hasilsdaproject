...
<html>
    <head>
        ...
        <!------ Light Box ------>
        <link rel="stylesheet" href="<?php echo base_url(); ?>/application/assets/css/swipebox.css">
        <script src="<?php echo base_url(); ?>/application/assets/js/jquery.swipebox.min.js"></script>
        ...
        <link href="<?php echo base_url(); ?>/application/assets/css/animate.css" rel='stylesheet' type='text/css' />
        <script>
            new WOW().init();
        </script>
    </head>
    <body>
        <div class="header">
            <div class="header-left">
                <div class="logo">
                    <a href="<?php echo base_url(); ?>index.php/pages/view/semua"><img src="<?php echo base_url(); ?>/application/assets/images/logo.png" alt=""/></a>
                </div>
                <div class="menu">
                    <a class="toggleMenu" href="#"><img src="<?php echo base_url(); ?>/application/assets/<?php echo base_url(); ?>/application/assets/images/nav.png" alt="" /></a>
                    <ul class="nav" id="nav">
            ...
            <div class="header_right">
                ...
                <script src="<?php echo base_url(); ?>/application/assets/js/uisearch.js"></script>
                <script>
            new UISearch(document.getElementById('sb-search'));
                </script>
                <!----//search-scripts---->
                <?php if (empty(current_user())): ?>
                    <div id="loginContainer"><a href="#" id="loginButton"><img src="<?php echo base_url(); ?>/application/assets/images/login.png"><span>Masuk</span></a>
                        <div id="loginBox">
                ...
                <?php else: ?>
                    <div id="loginContainer"><a href="<?php echo site_url(); ?>/users/dashboards/logout"><img src="<?php echo base_url(); ?>/application/assets/images/login.png"><span>Keluar</span></a>
                    </div>
                <?php endif; ?>
                <div class="clearfix"></div>
            </div>
